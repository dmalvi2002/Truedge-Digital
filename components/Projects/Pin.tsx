    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 bg-gradient-to-t from-blue-950 via-purple-950 to-indigo-950 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden lg:w-[30rem] md:w-[26rem] backdrop-blur-md bg-black/30"
        >
